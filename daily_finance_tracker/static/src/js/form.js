odoo.define('daily_finance_tracker.form', [], function(require) {
    ...
    $(document).ready(function() {
        ...
        function addEntry() {
            const row = `
                <div class="entry-row neu-entry">
                    <div class="row">
                        <div class="col-md-3">
                            <select class="neu-input flow-type">
                                <option value="inflow">Inflow</option>
                                <option value="outflow">Outflow</option>
                            </select>
                        </div>
                        <div class="col-md-5">
                            <input type="text" class="neu-input flow-description" placeholder="Description"/>
                        </div>
                        <div class="col-md-3">
                            <input type="number" class="neu-input flow-amount" placeholder="Amount"/>
                        </div>
